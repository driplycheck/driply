const DICT = {
  ru: {
    ...
    consent_text: 'Прежде чем начать, посмотри два документа. В них написано, что мы собираем, что видят другие и по каким правилам работает сервис.',
    consent_age: 'Driply не для тех, кому меньше 13. Если тебе меньше 18 — пользуйся с согласия родителей.',
    consent_accept: 'Принимаю',
    sec_legal: 'Документы', privacy_policy: 'Политика конфиденциальности', terms_of_use: 'Условия использования',
  ...
  en: {
    ...
    consent_text: 'Before you start, take a look at two documents. They say what we collect, what other people see and the rules the service runs on.',
    consent_age: 'Driply is not for anyone under 13. If you are under 18, use it with your parents’ consent.',
