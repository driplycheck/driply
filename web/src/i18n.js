const DICT = {
  ru: {
    ...
    write_msg: 'Написать',
    language: 'Язык',
    appearance: 'Оформление', moderation: 'Модерация',
    mod_empty: 'Жалоб нет. Тут появятся образы, на которые пожаловались.',
    mod_forbidden: 'Доступ только у модератора',
    mod_hide: 'Скрыть образ', mod_dismiss: 'Отклонить', mod_hide_author: 'Скрыть все образы автора',
    mod_from: 'от {who}', mod_reports_n: '{n} жалобы на автора', mod_already_hidden: 'уже скрыт',
    ...
    consent_title: 'Правила и данные',
    consent_text: 'Прежде чем начать, отметь три пункта. Каждый документ можно открыть и прочитать.',
    consent_box_terms: 'Принимаю', consent_box_processing: 'Даю', consent_box_publication: 'Даю',
    consent_processing: 'согласие на обработку персональных данных',
    consent_publication: 'согласие на распространение',
    consent_optional: 'Что показывать другим (можно выключить)',
    consent_opt_gender: 'Пол в профиле', consent_opt_username: 'Мой @username в Telegram',
    consent_age: 'Driply — для тех, кому есть 14. Если тебе меньше 18, пользуйся с согласия родителей.',
    consent_accept: 'Принимаю',
    sec_legal: 'Документы', privacy_policy: 'Политика конфиденциальности', terms_of_use: 'Пользовательское соглашение',
    my_data: 'Мои данные', delete_account: 'Удалить аккаунт',
    data_title: 'Мои данные', data_intro: 'Копия всего, что о тебе хранится. Можно скопировать и сохранить.',
    data_get: 'Показать мои данные', data_copy: 'Скопировать', data_copied: 'Скопировано',
    del_title: 'Удалить аккаунт', del_warn: 'Удалятся профиль, все образы, оценки, подписки и переписка с поддержкой. Дрипы и статусы сгорят. Отменить нельзя.',
    del_confirm_hint: 'Чтобы подтвердить, введи слово УДАЛИТЬ', del_word: 'УДАЛИТЬ', del_do: 'Удалить навсегда', del_done: 'Аккаунт удалён',
    legal_updated: 'Обновлено', legal_contact: 'Вопросы по данным:',
    onb_consent: 'Продолжая, ты соглашаешься с {terms} и {privacy}.',
    onb_consent_terms: 'условиями использования', onb_consent_privacy: 'политикой конфиденциальности',
    support_lead: 'Что-то не работает, есть идея или вопрос — напиши. Читаю лично.',
    support_label: 'Сообщение',
    support_kind_bug: '🛠 Не работает', support_kind_idea: '💡 Идея', support_kind_partner: '🤝 Сотрудничество',
    support_ph_bug: 'Что сломалось и на каком экране',
    support_ph_idea: 'Что бы ты добавил или изменил',
    support_ph_partner: 'Кто ты и что предлагаешь',
    support_send: 'Отправить', support_failed: 'Не отправилось, попробуй ещё раз',
    support_too_often: 'Слишком много обращений подряд. Продолжим через час.',
    support_too_short: 'Слишком коротко — опиши подробнее.',
    support_sent_title: 'Отправлено', support_sent_hint: 'Ответ придёт сообщением от бота Driply.',
    support_write_more: 'Написать ещё', support_note: 'Ответ приходит в чат с ботом, не в приложение.',
    ...
    price_placeholder: 'Цена, ₽ — её спрашивают чаще всего',
    draft_restored: 'Продолжаем незаконченный образ', draft_clear: 'Начать заново',
    publish: 'Опубликовать', nsfw_checking: 'Проверяем фото…',
    nsfw_blocked: 'Фото не проходит проверку: похоже на откровенный контент. Выбери другое.',
    ...
    first_drip_left: 'Статус first drip — первым 50 авторам. Свободно мест: {n}',
    ...
    auth_failed: 'Не удалось подтвердить вход, перезапусти приложение',
    err_generic: 'Что-то пошло не так, попробуй ещё раз',
    err_network: 'Нет связи с сервером, проверь интернет',
    err_not_delivered: 'Сообщение не дошло до поддержки, попробуй ещё раз',
    err_upload: 'Фото не загрузилось, проверь связь и попробуй снова',
    err_rate_limit: 'Слишком часто. Подожди немного и попробуй снова',
    err_too_short: 'Слишком коротко — опиши подробнее',
    err_self: 'С собой так нельзя',
    err_empty_nickname: 'Введи ник',
    err_invalid_amount: 'Не то количество дрипов',
    err_bad_image: 'Это фото не подошло, попробуй другое',
    err_post_gone: 'Образ уже удалён',
    err_no_user: 'Профиль не найден',
    ...
    tier_base: 'Новичок', tier_bronze: 'Дрип', tier_silver: 'Лорд', tier_gold: 'Икона',
    tier_to_bronze: 'Дрипа', tier_to_silver: 'Лорда', tier_to_gold: 'Иконы',
    profile_edit: 'Редактировать', profile_share: 'Поделиться', profile_looks_tab: 'Образы',
    share_story_btn: 'В историю', profile_invite: 'Пригласить',
    story_hint: 'В историю уходит твоя карточка со своей ссылкой: кто перейдёт и выложит образ — принесёт тебе 500.',
    story_rewarded: 'История опубликована, +{n} дрипов',
    story_shared: 'История опубликована. Награда раз в сутки',
  ...
  en: {
    ...
    write_msg: 'Message',
    language: 'Language',
    appearance: 'Appearance', moderation: 'Moderation',
    mod_empty: 'No reports. Reported looks will show up here.',
    mod_forbidden: 'Moderators only',
    mod_hide: 'Hide look', mod_dismiss: 'Dismiss', mod_hide_author: 'Hide all looks by author',
    mod_from: 'from {who}', mod_reports_n: '{n} reports on author', mod_already_hidden: 'already hidden',
    ...
    consent_title: 'Rules and data',
    consent_text: 'Before you start, tick three items. Each document can be opened and read.',
    consent_box_terms: 'I accept the', consent_box_processing: 'I give', consent_box_publication: 'I give',
    consent_processing: 'consent to personal data processing',
    consent_publication: 'consent to publication',
    consent_optional: 'What others may see (can be turned off)',
    consent_opt_gender: 'Gender in profile', consent_opt_username: 'My Telegram @username',
    consent_age: 'Driply is for users aged 14+. If you are under 18, use it with your parents’ consent.',
    consent_accept: 'I accept',
    sec_legal: 'Documents', privacy_policy: 'Privacy Policy', terms_of_use: 'Terms of Use',
    my_data: 'My data', delete_account: 'Delete account',
    data_title: 'My data', data_intro: 'A copy of everything stored about you. You can copy and save it.',
    data_get: 'Show my data', data_copy: 'Copy', data_copied: 'Copied',
    del_title: 'Delete account', del_warn: 'Your profile, all looks, votes, follows and support messages will be deleted. Drips and statuses are gone. This cannot be undone.',
    del_confirm_hint: 'To confirm, type the word DELETE', del_word: 'DELETE', del_do: 'Delete permanently', del_done: 'Account deleted',
    legal_updated: 'Updated', legal_contact: 'Data questions:',
    onb_consent: 'By continuing you agree to the {terms} and the {privacy}.',
    onb_consent_terms: 'terms of use', onb_consent_privacy: 'privacy policy',
    support_lead: 'Something broken, an idea or a question — write here. I read every message.',
    support_label: 'Message',
    support_kind_bug: '🛠 Bug', support_kind_idea: '💡 Idea', support_kind_partner: '🤝 Partnership',
    support_ph_bug: 'What broke and on which screen',
    support_ph_idea: 'What would you add or change',
    support_ph_partner: 'Who you are and what you propose',
    support_send: 'Send', support_failed: 'Failed to send, try again',
    support_too_often: 'Too many messages in a row. Let\u2019s continue in an hour.',
    support_too_short: 'Too short — add some detail.',
    support_sent_title: 'Sent', support_sent_hint: 'The reply will come as a message from the Driply bot.',
    support_write_more: 'Write again', support_note: 'Replies arrive in the bot chat, not in the app.',
    ...
    price_placeholder: 'Price, ₽ — the most asked question',
    draft_restored: 'Picking up your unfinished look', draft_clear: 'Start over',
    publish: 'Publish', nsfw_checking: 'Checking photo…',
    nsfw_blocked: 'This photo looks explicit and can’t be posted. Pick another one.',
    ...
    first_drip_left: 'The first drip status goes to the first 50 authors. Spots left: {n}',
    ...
    auth_failed: 'Couldn’t verify your login, restart the app',
    err_generic: 'Something went wrong, try again',
    err_network: 'No connection to the server, check your internet',
    err_not_delivered: 'The message didn’t reach support, try again',
    err_upload: 'The photo didn’t upload, check your connection and try again',
    err_rate_limit: 'Too often. Wait a bit and try again',
    err_too_short: 'Too short — add some detail',
    err_self: 'You can’t do that to yourself',
    err_empty_nickname: 'Enter a nickname',
    err_invalid_amount: 'Wrong amount of drips',
    err_bad_image: 'This photo didn’t work, try another one',
    err_post_gone: 'This look is already gone',
    err_no_user: 'Profile not found',
    err_forbidden: 'No access',
    ...
    tier_base: 'Rookie', tier_bronze: 'Drip', tier_silver: 'Lord', tier_gold: 'Icon',
    tier_to_bronze: 'Drip', tier_to_silver: 'Lord', tier_to_gold: 'Icon',
    profile_edit: 'Edit', profile_share: 'Share', profile_looks_tab: 'Looks',
    share_story_btn: 'To story', profile_invite: 'Invite',
    story_hint: 'Your story carries your own link: whoever joins and posts a look brings you 500.',
    story_rewarded: 'Story posted, +{n} drips',
    story_shared: 'Story posted. Reward once a day',
